...
export function safeTxHashCommand(program: Command) {
  program
    ...
    .argument('<DATA>')
    .argument('<NONCE>')
    .option('-o, --operation <OP>', 'Operation type (0: call, 1: delegatecall)', '0')
    .option('-s, --safe-tx-gas <GAS>', 'Safe tx gas', '0')
    .option('-b, --base-gas <GAS>', 'Base gas', '0')
    .option('-g, --gas-price <PRICE>', 'Gas price', '0')
    .option('-t, --gas-token <TOKEN>', 'Gas token', '0x0000000000000000000000000000000000000000')
    .option('-r, --refund-receiver <RECEIVER>', 'Refund receiver', '0x0000000000000000000000000000000000000000')
